...
-- -----------------------------------------------------
-- Placeholder table for view `slit`.`modulnedlast`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `slit`.`modulnedlast` (`Bruker_brukerId` INT, `brukerFornavn` INT, `brukerEtternavn` INT, `modulfilDato` INT, `modulfilBlob` INT, `Modul_modulNummer` INT);
...
-- -----------------------------------------------------
-- View `slit`.`modulnedlast`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `slit`.`modulnedlast`;
USE `slit`;
CREATE  OR REPLACE VIEW `modulnedlast` AS
    SELECT 
        `modulfil`.`Bruker_brukerId` AS `Bruker_brukerId`,
        `bruker`.`brukerFornavn` AS `brukerFornavn`,
        `bruker`.`brukerEtternavn` AS `brukerEtternavn`,
        `modulfil`.`modulfilDato` AS `modulfilDato`,
        `modulfil`.`modulfilBlob` AS `modulfilBlob`,
        `modulfil`.`Modul_modulNummer` AS `Modul_modulNummer`
    FROM
        ((`modulfil`
        JOIN `bruker` ON ((`modulfil`.`Bruker_brukerId` = `bruker`.`brukerId`))))
    GROUP BY `modulfil`.`Bruker_brukerId`
